...
@Entity
@Table(name = "Factureachatcarburant")
public class Factureachatcarburant {
	@Id
	...
	@Transient
	private List<Achatcarburant> listarticle;
	@Transient
	...
	private List<Achatcarburant> achats;
	...
	public List<Achatcarburant> getAchats() {
		return achats;
	}
	public void setAchats(List<Achatcarburant> achats) {
		this.achats = achats;
	}
	...
	public List<Achatcarburant> getListarticle() {
		return listarticle;
	}
	public void setListarticle(List<Achatcarburant> listarticle) {
		this.listarticle =new ArrayList<Achatcarburant>();
