...
@Entity
@Table(name = "Transactiondepense")
public class TransactionDepense {
	@Id
...
private List<Depensegestat> depensegestats;
...
public Vhecule getVhicule() {
	return vhicule;
}
public void setVhicule(Vhecule vhicule) {
	this.vhicule = vhicule;
}
...
public List<Depensegestat> getDepensegestats() {
	return depensegestats;
}
public void setDepensegestats(List<Depensegestat> depensegestats) {
	this.depensegestats = depensegestats;
}
