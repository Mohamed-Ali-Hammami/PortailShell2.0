...
public class FournisseurBean {
	...
	public void onRowEdit(RowEditEvent event){
			...
			FacesMessage msg=new FacesMessage(FacesMessage.SEVERITY_INFO,"fournisseur changé",((Fournisseur)event.getObject()).getNom());
	...
	public String deletefournisseur(){
		...
		Tracegestat t=new Tracegestat();
	 	...
	 	t.setAction("supression du fournisseur   "+fournisseur2.getNom() );
	 	t.setDate(new Date());
